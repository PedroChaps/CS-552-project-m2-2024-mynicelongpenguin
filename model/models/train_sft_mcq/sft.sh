...
echo "Going to run the program..."
    ...
    # --dataset_name "/scratch/izar/aloureir/project-m2-2024-mynicelongpenguin/data/Transformed_DeepMind_Algebra_QA_with_explanation.jsonl" \
    # --sample_quantity 10000 \
python3 train_sft_mcq/sft/train_sft.py --lr 1e-5 \
    --dataset_name "/scratch/izar/aloureir/project-m2-2024-mynicelongpenguin/data/Transformed_SciQ_Dataset_with_explanation.jsonl" \
    --output_dir "/scratch/izar/aloureir/project-m2-2024-mynicelongpenguin/model/models/outputs/sft_model_try" \
